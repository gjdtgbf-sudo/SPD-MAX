...
Version: 2.4 - واجهة أزرار ديناميكية للحزم (Dynamic Buttons)
"""
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("SPD Tool - أزرار الحزم الديناميكية - by yousef ekramy")
        self.setMinimumSize(1000, 700)
        self.current_worker = None
        self.use_hdlc = False
        self.reboot_buttons = [] # List to store dynamic reboot buttons
    ...
    def setup_ui(self):
        ...
        label_about = QLabel("المطور: yousef ekramy\n\n"
                            "الإصدار: 2.4 - أزرار ديناميكية\n\n"
                            "مميزات الإصدار:\n"
                            "1. أزرار ديناميكية لكل حزمة\n"
                            "2. وصف الفائدة على الزر مباشرة\n"
                            "3. تنفيذ فوري عند الضغط\n"
                            "4. دعم بروتوكول HDLC\n\n"
                            "يمكنك الآن الضغط على أي زر من قسم إعادة التشغيل\n"
                            "لإرسال الأمر مباشرة للجهاز.")
    ...
    def disable_buttons(self, state=True):
        ...
        # Disable all dynamic reboot buttons
